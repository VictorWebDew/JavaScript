...
coursesArray.forEach(item=>{
    ...
    const houreDiv = document.createElement('div');
    durationDiv.append(monthDiv, houreDiv)
    durationDiv.style.display = 'flex'
    monthDiv.style.width = '25%'
    houreDiv.style.width = '75%'
    const modulesDiv = document.createElement('div');
    titleDiv.innerText = item.title
    monthDiv.innerText = item.monthDuration
    houreDiv.innerText = item.hourDuration
    item.modules.forEach(module =>{
        const moduleDiv = document.createElement('div');
        moduleDiv.innerText = module
        moduleDiv.appendChild(moduleDiv)
    })
    itemDiv.appendChild(titleDiv, durationDiv, modulesDiv)
